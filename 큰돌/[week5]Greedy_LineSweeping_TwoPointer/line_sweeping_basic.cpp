...
typedef pair<int,int> P; // TODO: pair 타입정의해서 쓰는 것
P L[1000004];
int n, from, to, l, r, ret;
int main(){
  // TODO: 1. 라인스위핑: "정렬 후 왼쪽->오른쪽/오른쪽->왼쪽 탐색"하는 알고리즘 
  // 최대의 구간,횟수 찾기에 많이 쓰임
  // 배열은 요소 3000만 까지만 가능.
  ...
  sort(L, L + n); // TODO: 배열 정렬. 벡터정렬시는 iter를 쓰도록 begin, end 써주고, 배열 정렬은 주소값 넘겨줌
  l = L[0].first; 
  r = L[0].second;
  for(int i = 1; i < n; i++){
